 ...
 * 
 * publishes to:
 *   fake_odom_wheel_encoder_euler
 *   fake_odom_wheel_encoder_quat
 * 
 * resources
...
int main(int argc, char **argv){
    ...
    // publishers
    odom_data_pub = nh.advertise<nav_msgs::Odometry>("fake_odom_wheel_encoder_euler", 100);   // simple odom message, orientation.z is an euler angle
    odom_data_pub_quat = nh.advertise<nav_msgs::Odometry>("fake_odom_wheel_encoder_quat", 100);   // full odom message, orientation.z is quaternion
