...
const double WHEEL_RADIUS = 0.13; // (in metres)
const double WHEEL_BASE = 0.916; // (centre of left tire to centre of right tire)
const double TICKS_PER_METRE_LEFT = 1600; 
const double TICKS_PER_METRE_RIGHT = 1600;
